...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Aqui você consegue editar informações do seu perfil'),
        'class' => 'col-lg-7'
    ])   
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirme Nova Senha') }}</label>
