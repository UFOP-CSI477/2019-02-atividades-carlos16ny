                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-type">{{ __('Nível de Acesso') }}</label>
                                    <select name="type" id="" class="form-control form-control-alternative">
                                        <option value="1" {{ __($user->type == 1 ? 'selected' : '') }}>Admin</option>
                                        <option value="2" {{ __($user->type == 2 ? 'selected' : '') }}>Usuário</option>
                                    </select>
                                </div>
